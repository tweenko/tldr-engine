...
if page == 1 { // save menu
	...
	for (var i = 0; i < maxslots; ++i) {
		...
		if array_length(global.saves) <= i || global.saves[i] == -1 {
			...
			draw_set_halign(fa_center)
			draw_text_transformed(320, 48 + i*space + spacing, "New File", 2, 2, 0)
	...
	if prog != 1 
		draw_text_transformed(320, 402 - 8, "Return", 2, 2, 0)
	...
	if prog == 2 {
		...
		{
			draw_set_halign(fa_center)
			draw_text_transformed(320, 131 - 8, $"Overwrite Slot {s_selection + 1}?", 2, 2, 0)
		...
		draw_text_transformed(170, 332 - 8, "Save", 2, 2, 0)
		...
		draw_text_transformed(350, 332 - 8, "Return", 2, 2, 0)
		draw_set_color(c_white)
	}
}
if page == 2 { // storage
	...
	draw_text_transformed(61, 291, "STORAGE", 1, 1, 0)
	draw_text_ext_transformed(61, 361, $"Page\n{st_stpage + 1}/{st_maxstpage}", 20, -1, 1, 1, 0)
	draw_set_color(c_white)
