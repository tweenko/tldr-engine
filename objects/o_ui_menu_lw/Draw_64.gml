...
{ // middle
	...
	for (var i = 0; i < array_length(options); ++i) {
		...
		if !options[i].selectable draw_set_color(c_gray)
...
if state == 3{ // stats
	var stats = {
		...
		since_chapter: save_get("lw_since_chapter"), //0 if you don't want it to be displayed
		lv: save_get("lw_lv"),
...
//draw_sprite_ext(spr_ref_lw_menu,3,0,0,1,1,0,c_white,.25)