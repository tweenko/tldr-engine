...
// shader prep
shd = shd_intro_ch5_bg;

texBubble = sprite_get_texture(spr_intro_ch5_bg_bubbles, 0);
texGradient = sprite_get_texture(spr_intro_ch5_gradient, 0);
texStars = sprite_get_texture(spr_intro_ch5_bg_stars, 0);
...
//variables
logoSprGlow = spr_intro_ch5_logo;
