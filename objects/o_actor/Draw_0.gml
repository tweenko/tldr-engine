...
if (hurt > 0 && is_in_battle || run_away && is_in_battle && is_enemy) && !(instance_exists(o_enc) and (is_player || is_follower) and o_enc.party_state[party_get_index(name)] == PARTY_STATE.DEFEND)
	spr = s_hurt
