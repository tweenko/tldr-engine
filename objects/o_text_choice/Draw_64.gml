...
if array_length(choices) > 0 {
	if selection == 0 {
		...
		draw_sprite_ext(spr_ui_soul, 0, x + 60 - 32 + shake_x, y + 58, 2, 2, 0, c_red, 1)
	}
...
if selection == -1 
	draw_sprite_ext(spr_ui_soul, 0, x + shake_x + 320 - 10 - array_length(choices[1])*2 - 32, y + 58, 2, 2, 0, c_red, 1)