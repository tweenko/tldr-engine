__intro_seq = function(){
	...
	sprite_index = spr_queen_wireframe_rotate;
	image_index = 0;
	image_speed = 0;
	image_alpha = 0;
	...
	cutscene_sleep(20);
	cutscene_set_variable(self, "sprite_index", spr_queen_wireframe);
	//cutscene_set_variable(self, "imgSpd", 0);
	cutscene_set_variable(self, "image_index", 0);
	
	cutscene_sleep(30);
	cutscene_set_variable(self, "sprite_index", spr_queen_wireframe_laugh);
	cutscene_audio_play(snd_queen_bitcrushlaugh, false, 1.2);
	//cutscene_set_variable(self, "imgSpd", 0.2);
	
	cutscene_sleep(40);
	cutscene_audio_play(snd_explosion_mmx3);
	cutscene_set_variable(self, "sprite_index", spr_queen_wireframe_explode);
	cutscene_set_variable(self, "image_index", 0);
	//cutscene_set_variable(self, "imgSpd", 8/30);
