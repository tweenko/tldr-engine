...
if jump_reach > 4
    draw_sprite_ext(spr_climb_traj_hint, draw_get_subimg(spr_climb_traj_hint), get_leader().x + dx, get_leader().y + dy - 1, 1, jump_reach / clamp(jump_reach_max, 0, 50), current_direction + 90, traj_color, 0.85 * fade_alpha);
